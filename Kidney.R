KidneyData <- read.csv("KidneyData.txt", sep="", stringsAsFactors=FALSE)
...
library(rstan)
model1<-stan('./stan/Nonhierarchical.stan',data=data1)
check_hmc_diagnostics(model1)
model2<-stan('./stan/Hierarchical.stan',data=data2)
